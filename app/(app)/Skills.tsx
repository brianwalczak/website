			...
			>
				{skillsTab === "frontend" && (
					<>
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-10 text-header" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							...
							{/* altered JS logo for TS with Claude Sonnet 4.5 (fontawesome still doesn't have a TS logo...) */}
							<span className="text-sm text-center">Typescript</span>
						</div>
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-10 text-header" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							...
							<span className="text-sm text-center">EJS</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-10 text-header" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
				...
				{skillsTab === "backend" && (
					<>
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-10 text-header" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
							...
							<span className="text-sm text-center">Express</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-9 my-0.5 text-header" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 58 72">
							...
							<span className="text-sm text-center">Prisma</span>
						</div>
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							...
							<span className="text-sm text-center">Discord.js</span>
						</div>
					</>
				)}
				...
				{skillsTab === "software" && (
					<>
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							...
							<span className="text-sm text-center">Bash</span>
						</div>
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							...
							<span className="text-sm text-center">Arduino</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-10 text-header" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
						...
						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							...
							<span className="text-sm text-center">Blender</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-9 my-0.5 text-header" fill="currentColor" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
								...
								<path d="M460.72 117.978c11.75-.1 23.532-.1 35.28-.133-.266 119.285-.033 238.535-.133 357.82H82.565c-10.75-1.665-21.267-8.82-23.43-20.002-2.064-12.814-.566-25.861-.633-38.741 12.082-7.123 23.997-14.48 36.045-21.601 15.943 1.365 31.918.566 47.86.134 106.137-.201 212.276-.034 318.414-.134-.067-92.426.1-184.884-.1-277.343" fill="#dfdbdb" />
							</svg>

							<span className="text-sm text-center">Fusion 360</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<svg className="size-8 my-1 text-header" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
							...
							<span className="text-sm text-center">VS Code</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<h1 className="text-3xl mt-1 font-extrabold text-header">Ps</h1>

							<span className="text-sm text-center">Adobe Photoshop</span>
						</div>

						<div className="flex flex-col items-center gap-3 p-4 border border-surface-border bg-surface rounded-xl hover:border-surface-border-hover transition">
							<h1 className="text-3xl mt-1 font-extrabold text-header">Ai</h1>

							<span className="text-sm text-center">Adobe Illustrator</span>
						</div>
					</>
				)}
			</div>
