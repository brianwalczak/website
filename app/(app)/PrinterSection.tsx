					...
					<div className="flex items-center justify-between gap-4">
						<div className="flex items-center gap-3 min-w-0">
							...
							<div className="min-w-0 text-base">
								<h2 className="text-purple-400 mb-0.5">My Printer</h2>
								<p className="group-hover:text-text-hover transition-colors duration-200">Send me a message and it&apos;ll physically print as a sticker on my desk!</p>
							</div>
						</div>
