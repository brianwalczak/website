					...
					<div className="flex items-center justify-between gap-4">
						<div className="flex items-center gap-3 min-w-0">
							<div className="shrink-0 bg-purple-500/10 border border-purple-500/20 group-hover:bg-purple-500/20 group-hover:border-purple-500/40 rounded-lg p-2 transition-all duration-200">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-5 text-purple-400">
							...
							<div className="min-w-0">
								<h2 className="mono text-purple-400 text-sm mb-0.5">My Printer</h2>
								<p className="text-zinc-400 text-base group-hover:text-zinc-300 transition-colors duration-200">Send me a message and it&apos;ll physically print as a sticker on my desk!</p>
							</div>
						</div>
